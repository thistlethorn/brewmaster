...
const { handleMonarchEntry } = require('@core_tavernborne/handlers/handleMonarchGiveaway.js');
const { scheduleDailyReminder, sendReminder } = require('@core_tavernborne/tasks/dailyReminder.js');
...
module.exports = {
	...
	async execute(interaction) {
		...
		try {
			...
			try {
				gameMasterCommand = require('@core_tavernborne/handlers/handleGameMasterInteraction.js');
			}
			catch (err) {
