...
const { checkBetatestLock } = require('@core_tavernborne/utils/betaLock.js');
...
const { handleSpellbookInteraction } = require('@core_tavernborne/handlers/handleSpellbook.js');
...
module.exports = {
	...
	async buttons(interaction) {
		...
		if (command === 'unseal' && action === 'start') {
			const unsealCommand = require('@core_tavernborne/commands/charsys/unseal.js');
