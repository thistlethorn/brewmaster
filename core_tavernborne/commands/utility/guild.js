...
const {
	arrayTierEmoji,
	ONLY_CRESTS,
} = require('@core_tavernborne/data/emoji.js');

const { getTonyQuote } = require('@core_tavernborne/utils/tonyDialogue.js');
const { getTierBenefits, getTierData } = require('@core_tavernborne/utils/getTierBenefits.js');
